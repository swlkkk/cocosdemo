    ...
    execute: function () {
      ...
      _export("avatarts", avatarts = (_dec = ccclass('avatarts'), _dec(_class = class avatarts extends Component {
        ...
        getUserAvatar(remoteUrl) {
          ...
          if (!this.isAssetTypeImage(ext)) {
            ...
            assetManager.loadRemote(remoteUrl, (err, imageAsset) => {
              if (!err && imageAsset) {
                var spFrame = this.cache[imageAsset.uuid];
        ...
        releaseRemoteSprite(node) {
          ...
          var sp = node.getChildByName('avatar').getComponent(_crd && GPRoundBoxSprite === void 0 ? (_reportPossibleCrUseOfGPRoundBoxSprite({
            error: Error()
...
//# sourceMappingURL=b4f6451b80af6e3dde63999cd5f0700916d9b2ee.js.map