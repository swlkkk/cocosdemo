System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, director, native, game, sys, settleTs, awardCl, coinCreate, chargList, _dec, _class, _crd, ccclass, property, popcontrol;
          ...
          if (surplus != null) {
            ...
            if (type) {
              if (sys.os == sys.OS.ANDROID && sys.isNative) {
                this.popNum++;
                var arr = JSON.parse(native.reflection.callStaticMethod("com/lotogram/tbjdwc/mvvm/ui/activity/TuibiDevicesActivity", "getProducts", "()Ljava/lang/String;"));
                this.node.getChildByName('charge_node').getChildByName('ScrollView').getChildByName('view').getChildByName('content').getComponent(_crd && chargList === void 0 ? (_reportPossibleCrUseOfchargList({
                  error: Error()
...
//# sourceMappingURL=e20fd1484ccad10f3b2d9e72b25f7241f265c495.js.map