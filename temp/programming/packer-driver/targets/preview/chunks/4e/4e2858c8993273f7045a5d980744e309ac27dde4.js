System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Sprite, resources, SpriteFrame, instantiate, Label, xmlAnim, lxts, machine, flashPicts, labelts, _dec, _dec2, _class, _class2, _descriptor, _crd, ccclass, property, xmlts;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("xmlts", xmlts = (_dec = ccclass('xmlts'), _dec2 = property(Sprite), _dec(_class = (_class2 = class xmlts extends Component {
        ...
        onLoad() {
          ...
          var _loop = function _loop(i) {
            resources.load(_this.itemSpritePathArray[i], SpriteFrame, (err, asset) => {
              if (i == 0) {
                _this.girds[i].spriteFrame = asset;
              }

              _this.xmloutArr[i] = asset;
            });
          };
        ...
        toRoll(pos) {
          var xmlanim = this.node.getChildByName('xmlAnim').getComponent(_crd && xmlAnim === void 0 ? (_reportPossibleCrUseOfxmlAnim({
            error: Error()
          }), xmlAnim) : xmlAnim);
          ...
          if (pos !== this.stopPos) {
            ...
            setTimeout(() => {
              ...
              if (this.stopPos == 0 || this.stopPos == 6 || this.stopPos == 10 || this.stopPos == 16) {
                ...
                var mcts = this.node.parent.getChildByName('Machine').getComponent(_crd && machine === void 0 ? (_reportPossibleCrUseOfmachine({
                  error: Error()
                }), machine) : machine);
                ...
                if (this.node.parent.getChildByName('lxshow') != null) {
                  ...
                  // 生成获奖展示界面
                  var lxshow = instantiate(mcts.lxItem);
                ...
                var _xmlanim = this.node.getChildByName('xmlAnim').getComponent(_crd && xmlAnim === void 0 ? (_reportPossibleCrUseOfxmlAnim({
                  error: Error()
                }), xmlAnim) : xmlAnim);

                this.retunxmlScore(pos);

                _xmlanim.switchThree(1, false);

                _xmlanim.switchTwo(true); // 闪屏图片
                ...
                setTimeout(() => {
                  ...
                  _xmlanim.switchThree(1, true);

                  _xmlanim.switchTwo(false);
...
//# sourceMappingURL=4e2858c8993273f7045a5d980744e309ac27dde4.js.map