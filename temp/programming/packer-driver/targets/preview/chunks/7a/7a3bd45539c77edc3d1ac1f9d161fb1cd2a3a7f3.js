    ...
    execute: function () {
      ...
      _export("pushplate", pushplate = (_dec = ccclass('pushplate'), _dec(_class = class pushplate extends Component {
        ...
        start() {
          ...
          var pushRigbody = this.node.getComponent(RigidBody);
          pushRigbody.type = 4;
          pushRigbody.group = 4;
        ...
        rotationPlate(node) {
          ...
          var inSide = tween().to(1.3, {
            position: this.moveIn
          }, {
            easing: 'linear'
          });
          var outSide = tween().to(1.3, {
...
//# sourceMappingURL=7a3bd45539c77edc3d1ac1f9d161fb1cd2a3a7f3.js.map