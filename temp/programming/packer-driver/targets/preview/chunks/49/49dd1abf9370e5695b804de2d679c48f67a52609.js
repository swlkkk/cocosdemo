    ...
    execute: function () {
      ...
      _export("machine", machine = (_dec = ccclass('machine'), _dec2 = property(Prefab), _dec3 = property(Prefab), _dec4 = property(Prefab), _dec5 = property(Prefab), _dec6 = property(Prefab), _dec7 = property(Prefab), _dec8 = property(Prefab), _dec9 = property(Prefab), _dec10 = property(Node), _dec11 = property(Node), _dec12 = property(Node), _dec13 = property(Material), _dec14 = property(Material), _dec15 = property(Material), _dec16 = property(Material), _dec17 = property(Material), _dec18 = property(Material), _dec(_class = (_class2 = class machine extends Component {
        ...
        setAward(type, subtype) {
          ...
          var spinAct = this.node.parent.parent.parent.getChildByName('tuibiji').getChildByName('component').getChildByName('spin').getComponent(_crd && spin === void 0 ? (_reportPossibleCrUseOfspin({
            error: Error()
          }), spin) : spin);
          /* 此处是设置最终结果逻辑 */
        ...
        spawnLine(type, subtype) {
          ...
          if (type == 1) {
            ...
            if (lialionLine.getChildByName('lineitem') != null) {
              ...
              var _lineitem = instantiate(this.lineitem);

              _lineitem.name = 'lineitem';

              _lineitem.setPosition(0, 3.5, 0);

              lialionLine.addChild(_lineitem);
            }
          } else if (type == 3) {
            // jp3连线奖
            if (lialionLine.getChildByName('lineitem') != null) {
              ...
              var _lineitem2 = instantiate(this.lineitem);

              _lineitem2.name = 'lineitem';

              _lineitem2.setPosition(0, -3.6, 0);

              lialionLine.addChild(_lineitem2);
            }
          } else if (type == 4) {
            // 全盘奖
            if (lialionLine.getChildByName('lineitem') != null) {
              ...
              var _lineitem3 = instantiate(this.lineitem);

              _lineitem3.name = 'lineitem';

              _lineitem3.setPosition(0, 0, 0);

              lialionLine.addChild(_lineitem3);
            }
            ...
            if (subtype == 1) {
              if (this.randomsub == 0) {
                if (lialionLine.getChildByName('lineitem') != null) {
                  ...
                  var _lineitem4 = instantiate(this.lineitem);

                  _lineitem4.name = 'lineitem';

                  _lineitem4.setPosition(0, 3.5, 0);

                  lialionLine.addChild(_lineitem4);
                }
              } else if (this.randomsub == 1) {
                if (lialionLine.getChildByName('lineitem') != null) {
                  lialionLine.getChildByName('lineitem').setRotationFromEuler(0, 0, 0);
                  ...
                  var _lineitem5 = instantiate(this.lineitem);

                  _lineitem5.name = 'lineitem';

                  _lineitem5.setPosition(0, 0, 0);

                  lialionLine.addChild(_lineitem5);
                }
              } else if (this.randomsub == 2) {
                if (lialionLine.getChildByName('lineitem') != null) {
                  lialionLine.getChildByName('lineitem').setRotationFromEuler(0, 0, 0);
                  ...
                  var _lineitem6 = instantiate(this.lineitem);

                  _lineitem6.name = 'lineitem';

                  _lineitem6.setPosition(0, -3.6, 0);

                  lialionLine.addChild(_lineitem6);
                }
              }
            } else if (subtype == 2) {
              if (this.randomsub[0] == 0) {
                if (lialionLine.getChildByName('lineitem') != null) {
                  ...
                  var _lineitem7 = instantiate(this.lineitem);

                  _lineitem7.name = 'lineitem';

                  _lineitem7.setPosition(0, 3.5, 0);

                  lialionLine.addChild(_lineitem7);
                }
                ...
                if (lialionLine.getChildByName('lineitem') != null) {
                  ...
                  var _lineitem8 = instantiate(this.lineitem);

                  _lineitem8.name = 'lineitem';

                  _lineitem8.setPosition(0, 0, 0);

                  lialionLine.addChild(_lineitem8);
                }
                ...
                if (lialionLine.getChildByName('lineitem') != null) {
                  ...
                  var _lineitem9 = instantiate(this.lineitem);

                  _lineitem9.name = 'lineitem';

                  _lineitem9.setPosition(0, -3.6, 0);

                  lialionLine.addChild(_lineitem9);
                }
              }
              ...
              if (this.randomsub[1] == 0) {
                ...
                if (lialionLine.getChildByName('lineitem1') != null) {
                  ...
                  var _lineitem10 = instantiate(this.lineitem);

                  _lineitem10.name = 'lineitem1';

                  _lineitem10.setPosition(0, 0, 0);

                  lialionLine.addChild(_lineitem10);
                }
                ...
                if (lialionLine.getChildByName('lineitem1') != null) {
                  ...
                  var _lineitem11 = instantiate(this.lineitem);

                  _lineitem11.name = 'lineitem1';

                  _lineitem11.setPosition(0, -3.6, 0);

                  lialionLine.addChild(_lineitem11);
                }
              }
            } else if (subtype == 3) {
              if (lialionLine.getChildByName('lineitem') != null) {
                ...
                var _lineitem12 = instantiate(this.lineitem);

                _lineitem12.name = 'lineitem';

                _lineitem12.setPosition(0, 0, 0);

                lialionLine.addChild(_lineitem12);
              }
              ...
              if (lialionLine.getChildByName('lineitem2') != null) {
                ...
                var _lineitem13 = instantiate(this.lineitem);

                _lineitem13.name = 'lineitem2';

                _lineitem13.setPosition(0, 3.5, 0);

                lialionLine.addChild(_lineitem13);
              }
              ...
              if (lialionLine.getChildByName('lineitem3') != null) {
                ...
                var _lineitem14 = instantiate(this.lineitem);

                _lineitem14.name = 'lineitem3';

                _lineitem14.setPosition(0, -3.6, 0);

                lialionLine.addChild(_lineitem14);
              }
            }
          } else if (type == 6) {
            // 叠叠乐
            if (lialionLine.getChildByName('lineitem') != null) {
              ...
              var _lineitem15 = instantiate(this.lineitem);

              _lineitem15.name = 'lineitem';

              _lineitem15.setPosition(0, 0, 0);

              _lineitem15.setRotationFromEuler(0, 0, 32);

              lialionLine.addChild(_lineitem15);
            }
          } else if (type == 7) {
            // 小玛丽
            if (lialionLine.getChildByName('lineitem') != null) {
              ...
              var _lineitem16 = instantiate(this.lineitem);

              _lineitem16.name = 'lineitem';

              _lineitem16.setRotationFromEuler(0, 0, -32);

              _lineitem16.setPosition(0, 0, 0);

              lialionLine.addChild(_lineitem16);
            }
          }
        }
        ...
        spinSwitch(type) {
          var spinAction = this.node.parent.parent.parent.getChildByName('tuibiji').getChildByName('component').getChildByName('spin');
