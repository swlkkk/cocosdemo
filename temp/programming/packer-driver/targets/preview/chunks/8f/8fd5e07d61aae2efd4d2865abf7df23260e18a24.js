System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, _dec, _class, _crd, ccclass, property, MD5;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "dcf4bjS2ZZPFrHm8XPcRz+i", "MD5", undefined);
      ...
      _export("MD5", MD5 = (_dec = ccclass('MD5'), _dec(_class = class MD5 extends Component {
        start() {}

        md5(md5str) {
          var createMD5String = function createMD5String(string) {
            var x = Array();
...
//# sourceMappingURL=8fd5e07d61aae2efd4d2865abf7df23260e18a24.js.map