  ...
  return {
    ...
    execute: function () {
      ...
      _export("GPRoundBoxSprite", GPRoundBoxSprite = (_dec = ccclass('GPRoundBoxSprite'), _dec2 = property({
        ...
        _flushAssembler() {
          var assembler = _crd && GPRoundBoxAssembler === void 0 ? (_reportPossibleCrUseOfGPRoundBoxAssembler({
            error: Error()
...
//# sourceMappingURL=4a6866cd03e3cdf304a23786ecdbd122dd8b07c4.js.map