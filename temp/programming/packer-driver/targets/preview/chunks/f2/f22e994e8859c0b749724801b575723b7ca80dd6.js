      ...
      _export("pdpool", pdpool = (_dec = ccclass('pdpool'), _dec2 = property(Prefab), _dec(_class = (_class2 = class pdpool extends Component {
        ...
        initEnemy() {
          for (var index = 0; index < 100; index++) {
            var randx = Number(this.randomNum(18.605, 45.505, 3));
            var randy = Number(this.randomNum(31.7, 32.2, 3));
            var randz = Number(this.randomNum(43.097, 53.673, 3));
            var pdCoin = instantiate(this.pdCoin);
