System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, tween, Vec3, BoxCollider, Prefab, instantiate, machine, coinCreate, lightNode, _dec, _dec2, _class, _class2, _descriptor, _crd, ccclass, property, spin;
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['_decorator', 'Component', 'Node', 'tween', 'Vec3', 'BoxCollider', 'ITriggerEvent', 'Prefab', 'instantiate']);
      ...
      _export("spin", spin = (_dec = ccclass('spin'), _dec2 = property(Prefab), _dec(_class = (_class2 = class spin extends Component {
        ...
        goLight() {
          let ln = this.node.parent.parent.parent.parent.getChildByName('Pusher').getChildByName('Main').getChildByName('Canvas').getChildByName('light_node').getComponent(_crd && lightNode === void 0 ? (_reportPossibleCrUseOflightNode({
            error: Error()
          }), lightNode) : lightNode);
          ln.spinLight('add');
        }
...
//# sourceMappingURL=c1734f01b16dfc1b55baea8773bb235251e74d97.js.map