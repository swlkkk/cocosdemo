    ...
    execute: function () {
      ...
      _export("awardSensing", awardSensing = (_dec = ccclass('awardSensing'), _dec(_class = class awardSensing extends Component {
        ...
        onTriggerEnter(event) {
          ...
          let flashPic = this.node.parent.getChildByName('Main').getChildByName('Canvas').getChildByName('flashNode').getComponent(_crd && flashPicts === void 0 ? (_reportPossibleCrUseOfflashPicts({
            error: Error()
          }), flashPicts) : flashPicts); // 闪屏数字

          let flashLabel = this.node.parent.getChildByName('Main').getChildByName('Canvas').getChildByName('labels').getComponent(_crd && labelts === void 0 ? (_reportPossibleCrUseOflabelts({
            error: Error()
          }), labelts) : labelts); // 拿到coinCreate主节点

          let cjTs = this.node.parent.getComponent(_crd && coinCreate === void 0 ? (_reportPossibleCrUseOfcoinCreate({
            error: Error()
          ...
          if (event.selfCollider.node.name == 'IncentiveCube1') {
            if (!cjTs.winning) {
              if (this.channel.indexOf(0) != -1) {
                cjTs.channelCount = 0;
                let sendData = cjTs.websocketFnc.ws_channelpass(0);
            ...
            if (!cjTs.winning) {
              if (this.channel.indexOf(1) != -1) {
                cjTs.channelCount = 1;
                let sendData = cjTs.websocketFnc.ws_channelpass(1);
                cjTs.websocket.websocket_sendMessage(sendData, cjTs.ws, cjTs.wsuuid, cjTs.wssalt);
                flashPic.doFlash(1);
            ...
            if (!cjTs.winning) {
              if (this.channel.indexOf(2) != -1) {
                cjTs.channelCount = 2;
                let sendData = cjTs.websocketFnc.ws_channelpass(2);
                cjTs.websocket.websocket_sendMessage(sendData, cjTs.ws, cjTs.wsuuid, cjTs.wssalt);
                flashPic.doFlash(2);
            ...
            if (!cjTs.winning) {
              if (this.channel.indexOf(3) != -1) {
                cjTs.channelCount = 3;
                let sendData = cjTs.websocketFnc.ws_channelpass(3);
                cjTs.websocket.websocket_sendMessage(sendData, cjTs.ws, cjTs.wsuuid, cjTs.wssalt);
                flashPic.doFlash(3);
            ...
            if (!cjTs.winning) {
              if (this.channel.indexOf(4) != -1) {
                cjTs.channelCount = 4;
                let sendData = cjTs.websocketFnc.ws_channelpass(4);
                cjTs.websocket.websocket_sendMessage(sendData, cjTs.ws, cjTs.wsuuid, cjTs.wssalt);
                flashPic.doFlash(4);
            ...
            if (!cjTs.winning) {
              if (this.channel.indexOf(5) != -1) {
                cjTs.channelCount = 5;
                let sendData = cjTs.websocketFnc.ws_channelpass(5);
                cjTs.websocket.websocket_sendMessage(sendData, cjTs.ws, cjTs.wsuuid, cjTs.wssalt);
                flashPic.doFlash(5);
            ...
            if (!cjTs.winning) {
              if (this.channel.indexOf(6) != -1) {
                cjTs.channelCount = 6;
                let sendData = cjTs.websocketFnc.ws_channelpass(6);
                cjTs.websocket.websocket_sendMessage(sendData, cjTs.ws, cjTs.wsuuid, cjTs.wssalt);
                flashPic.doFlash(6);
            ...
            if (!cjTs.winning) {
              if (this.channel.indexOf(7) != -1) {
                cjTs.channelCount = 7;
                let sendData = cjTs.websocketFnc.ws_channelpass(7);
                cjTs.websocket.websocket_sendMessage(sendData, cjTs.ws, cjTs.wsuuid, cjTs.wssalt);
                flashPic.doFlash(7);
...
//# sourceMappingURL=a2840473dac667f8d26826d90d6eafcc0fe50ccc.js.map