    ...
    execute: function () {
      ...
      _export("getScore", getScore = (_dec = ccclass('getScore'), _dec(_class = class getScore extends Component {
        ...
        onCollision(event) {
          ...
          let scoreno = this.node.parent.getChildByName('Main').getChildByName('Canvas').getChildByName('scoreAdd').getComponent(_crd && scoreAn === void 0 ? (_reportPossibleCrUseOfscoreAn({
            error: Error()
          }), scoreAn) : scoreAn);
...
//# sourceMappingURL=cb9cd7a3c8e5b25dcabe38b2b02917cf06302469.js.map