    ...
    execute: function () {
      ...
      _export("spin", spin = (_dec = ccclass('spin'), _dec2 = property(Prefab), _dec(_class = (_class2 = class spin extends Component {
        ...
        moveSpin(node, type) {
          ...
          let mover = (_crd && tween === void 0 ? (_reportPossibleCrUseOftween({
            error: Error()
          }), tween) : tween)().to(1.5, {
          ...
          let movel = (_crd && tween === void 0 ? (_reportPossibleCrUseOftween({
            error: Error()
          }), tween) : tween)().to(1.5, {
...
//# sourceMappingURL=cb78715bfc4cb39530269449007a39dfd2a5eed9.js.map