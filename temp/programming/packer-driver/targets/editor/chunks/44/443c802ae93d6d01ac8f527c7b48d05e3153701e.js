System.register(["__unresolved_0", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4"], function (_export, _context) {
  ...
  function _reportPossibleCrUseOfreq(extras) {
    _reporterNs.report("req", "./cocos.js", _context.meta, extras);
  }

  function _reportPossibleCrUseOfd(extras) {
    _reporterNs.report("d", "./cocos.js", _context.meta, extras);
  }
  ...
  return {
    ...
    execute: function () {
      _crd = true; // I am the facade module who provides access to the CommonJS module './cocos.js'~

      if (!(_crd && req === void 0 ? (_reportPossibleCrUseOfreq({
        error: Error()
      }), req) : req)) {
        loader.throwInvalidWrapper('./cocos.js', _context.meta.url);
      }
...
//# sourceMappingURL=443c802ae93d6d01ac8f527c7b48d05e3153701e.js.map