System.register(["__unresolved_0", "cc"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, dynamicAtlasManager, _crd, GPRoundBoxAssembler;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "82ce2jZvJZDmI8wo7vYjh+y", "GPRoundBoxAssembler", undefined);

      __checkObsolete__(['IAssembler', 'IRenderData', 'RenderData', 'dynamicAtlasManager']);

      _export("GPRoundBoxAssembler", GPRoundBoxAssembler = {
        // 根据圆角segments参数，构造网格的顶点索引列表
        GetIndexBuffer(sprite) {
          let indexBuffer = [0, 1, 2, 2, 3, 0, 4, 5, 6, 6, 7, 4, 8, 9, 10, 10, 11, 8]; // 为四个角的扇形push进索引值
        ...
        fillBuffers(sprite) {
          ...
          const vid = vidOrigin; // 沿着当前这个位置往后将我们这个对象的index放进去
        ...
        updateVertexData(sprite) {
          ...
          const right_r = right - sprite.radius; // 三个矩形的顶点
        ...
        updateUVs(sprite) {
          ...
          const uv = sprite.spriteFrame.uv; // 这里我打印了一下uv的值，第一个看上去是左上角，但其实，opengl端的纹理存在上下颠倒问题，所以这里其实还是左下角
          // 左下，右下，左上，右上
          ...
          const ch = uiTrans.height;
          const appX = uiTrans.anchorX * cw;
          const appY = uiTrans.anchorY * ch; // 用相对坐标，计算uv
...
//# sourceMappingURL=84b0bfa138a6af901bb26998a80f68262a360140.js.map