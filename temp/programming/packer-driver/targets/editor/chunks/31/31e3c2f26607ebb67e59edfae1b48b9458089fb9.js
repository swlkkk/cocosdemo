      ...
      _export("DebugViewRuntimeControl", DebugViewRuntimeControl = (_dec = ccclass('internal.DebugViewRuntimeControl'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Node), _dec(_class = (_class2 = class DebugViewRuntimeControl extends Component {
        ...
        start() {
          ...
          for (let i = 0; i < 2; i++) {
            ...
            const Label = newLabel.getComponent(Label);
            Label.string = i ? '----------Composite Mode----------' : '----------Single Mode----------';
            Label.color = Color.WHITE;
            Label.overflow = 0;
            this.labelComponentList[this.labelComponentList.length] = Label;
          }
          ...
          let Label = this.EnableAllCompositeModeButton.getComponentInChildren(Label);
          this.labelComponentList[this.labelComponentList.length] = Label;
          ...
          Label = changeColorButton.getComponentInChildren(Label);
          ...
          Label = HideButton.getComponentInChildren(Label);
          Label.string = 'Hide UI';
          this.labelComponentList[this.labelComponentList.length] = Label;
          this.hideButtonLabel = Label; // misc
