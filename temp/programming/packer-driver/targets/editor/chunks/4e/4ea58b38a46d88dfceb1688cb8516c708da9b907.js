  ...
  return {
    ...
    execute: function () {
      ...
      _export("menu", menu = (_dec = ccclass('menu'), _dec(_class = class menu extends Component {
        constructor(...args) {
          super(...args);
          this.menuSpritePath = ['btn_tbj_exit/spriteFrame', 'btn_tbj_putaway/spriteFrame', 'btn_tbj_mu/spriteFrame', 'btn_tbj_mu2/spriteFrame'];
...
//# sourceMappingURL=4ea58b38a46d88dfceb1688cb8516c708da9b907.js.map