System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "__unresolved_8", "__unresolved_9", "__unresolved_10", "__unresolved_11", "__unresolved_12", "__unresolved_13", "__unresolved_14", "__unresolved_15", "__unresolved_16", "__unresolved_17", "__unresolved_18", "__unresolved_19", "__unresolved_20", "__unresolved_21", "__unresolved_22", "__unresolved_23"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, Prefab, input, Input, game, Game, Vec3, RigidBody, instantiate, Label, sys, native, director, assetManager, poolManager, gameCore, machine, ddlts, xmlts, lxts, jpts, xmlAnim, socketApi, spin, maints, jpScorets, encrypt, socketFun, MD5, avatarts, awardCl, i18n, popcontrol, dcountChange, autoDropTs, AudioMgr, chargList, _dec, _dec2, _dec3, _dec4, _dec5, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _crd, ccclass, property, coinCreate;
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      chargList = _unresolved_24.chargList;
    }],
    execute: function () {
      _crd = true;
      ...
      _export("coinCreate", coinCreate = (_dec = ccclass('coinCreate'), _dec2 = property(Prefab), _dec3 = property(Prefab), _dec4 = property(Prefab), _dec5 = property(Node), _dec(_class = (_class2 = class coinCreate extends Component {
        ...
        start() {
          if (sys.os == sys.OS.ANDROID && sys.isNative) {
            ...
            native.bridge.onNative = (arg0, arg1) => {
              if (arg0 == 'cocos_getSound') {
                this.soundStatus = JSON.parse(arg1);
                ...
                this.node.getChildByName('Main').getChildByName('Canvas').getChildByName('avatarBox').getChildByName('vip_box').getChildByName('Label').getComponent(Label).string = this.userData.vip;
                this.node.getChildByName('Main').getChildByName('Canvas').getChildByName('user_property').getChildByName('click_box').getChildByName('coin_label').getComponent(Label).string = this.fillter(this.userData.coins);
              } else if (arg0 == 'cocos_token') {
                this.token = arg1;
              } else if (arg0 == 'cocos_vpinitRes') {
                this.vpinitRes = JSON.parse(arg1);
              ...
              } else if (arg0 == 'cocos_updata_user') {
                this.node.getChildByName('Main').getChildByName('Canvas').getChildByName('pop_node').getComponent(_crd && popcontrol === void 0 ? (_reportPossibleCrUseOfpopcontrol({
                  error: Error()
                }), popcontrol) : popcontrol).controlCharge(false);
                this.userData = JSON.parse(arg1);
                this.node.getChildByName('Main').getChildByName('Canvas').getChildByName('avatarBox').getChildByName('vip_box').getChildByName('Label').getComponent(Label).string = this.userData.vip;
                this.node.getChildByName('Main').getChildByName('Canvas').getChildByName('user_property').getChildByName('click_box').getChildByName('coin_label').getComponent(Label).string = this.fillter(this.userData.coins);
              } else if (arg0 == 'cocos_purchase_failed') {
                this.node.getChildByName('Main').getChildByName('Canvas').getChildByName('pop_node').getComponent(_crd && popcontrol === void 0 ? (_reportPossibleCrUseOfpopcontrol({
                  error: Error()
                }), popcontrol) : popcontrol).controlCharge(false);
              } else if (arg0 == 'cocos_getProducts') {
                let arr = JSON.parse(arg1);
                this.node.getChildByName('Main').getChildByName('Canvas').getChildByName('pop_node').getChildByName('charge_node').getChildByName('ScrollView').getChildByName('view').getChildByName('content').getComponent(_crd && chargList === void 0 ? (_reportPossibleCrUseOfchargList({
                  error: Error()
                }), chargList) : chargList).creation(arr);
                this.node.getChildByName('Main').getChildByName('Canvas').getChildByName('pop_node').getChildByName('charge_node').active = true;
                this.node.getChildByName('Main').getChildByName('Canvas').getChildByName('pop_node').active = true;
              }
            ...
            native.bridge.sendToNative('native_getSound');
          }
          ...
          if (this.yzcoin == null) {
            ...
            let yzcoin = instantiate(this.yzcoin);
        ...
        getUser() {
          if (sys.os == sys.OS.ANDROID && sys.isNative) {
            ...
            native.bridge.sendToNative('native_userData');
            native.bridge.sendToNative('native_token');
            native.bridge.sendToNative('native_vpinitRes');
            native.bridge.sendToNative('native_tag');
          }
        } // 获取上机信息
        ...
        websocketControlInit(url, isReConnect) {
          ...
          this.websocket.websocket_messageListen(this.ws, this.wsuuid, this.wssaltLen, res => {
            ...
            let SP = this.node.getChildByName('tuibiji').getChildByName('component').getChildByName('spin').getComponent(_crd && spin === void 0 ? (_reportPossibleCrUseOfspin({
              error: Error()
            }), spin) : spin);
              ...
              if (res.action == 0) {
                ...
                if (this.isDroped) {
                  ...
                  if (sys.isNative && (sys.os == sys.OS.IOS || sys.os == sys.OS.OSX)) {
                    ...
                    game.end(); // director.loadScene("scene-begin");
                  }
                }
              }
            }
        ...
        closeAuto() {
          ...
          let spinDm = this.node.getChildByName('tuibiji').getChildByName('component').getChildByName('spin').getComponent(_crd && spin === void 0 ? (_reportPossibleCrUseOfspin({
            error: Error()
          }), spin) : spin);
          clearInterval(this.autoTimer);
          this.autoTimer = null;
...
//# sourceMappingURL=0b1d014eaa9ae9d789cc75371837cd33955861ee.js.map