System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "__unresolved_8", "__unresolved_9", "__unresolved_10", "__unresolved_11", "__unresolved_12", "__unresolved_13", "__unresolved_14", "__unresolved_15", "__unresolved_16"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, Prefab, resources, Sprite, Vec3, UITransform, SpriteFrame, instantiate, NodePool, Label, _decorator, Component, Node, tween, MeshRenderer, Material, ddlts, xmlts, coinCreate, lineAnimate, AllAnimate, gameCore, lxts, jpts, spin, flashPicts, labelts, hyts, ddlhyts, xmlAnim, jpScorets, i18n, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _dec11, _dec12, _dec13, _dec14, _dec15, _dec16, _dec17, _dec18, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _descriptor9, _descriptor10, _descriptor11, _descriptor12, _descriptor13, _descriptor14, _descriptor15, _descriptor16, _descriptor17, _crd, ccclass, property, machine;
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      ddlts = _unresolved_2.ddlts;
    }, function (_unresolved_3) {
      xmlts = _unresolved_3.xmlts;
    }, function (_unresolved_4) {
      coinCreate = _unresolved_4.coinCreate;
    }, function (_unresolved_5) {
      lineAnimate = _unresolved_5.lineAnimate;
    }, function (_unresolved_6) {
      AllAnimate = _unresolved_6.AllAnimate;
    }, function (_unresolved_7) {
      gameCore = _unresolved_7.gameCore;
    }, function (_unresolved_8) {
      lxts = _unresolved_8.lxts;
    }, function (_unresolved_9) {
      jpts = _unresolved_9.jpts;
    }, function (_unresolved_10) {
      spin = _unresolved_10.spin;
    }, function (_unresolved_11) {
      flashPicts = _unresolved_11.flashPicts;
    }, function (_unresolved_12) {
      labelts = _unresolved_12.labelts;
    }, function (_unresolved_13) {
      hyts = _unresolved_13.hyts;
    }, function (_unresolved_14) {
      ddlhyts = _unresolved_14.ddlhyts;
    }, function (_unresolved_15) {
      xmlAnim = _unresolved_15.xmlAnim;
    }, function (_unresolved_16) {
      jpScorets = _unresolved_16.jpScorets;
    ...
    execute: function () {
      ...
      _export("machine", machine = (_dec = ccclass('machine'), _dec2 = property(Prefab), _dec3 = property(Prefab), _dec4 = property(Prefab), _dec5 = property(Prefab), _dec6 = property(Prefab), _dec7 = property(Prefab), _dec8 = property(Prefab), _dec9 = property(Prefab), _dec10 = property(Node), _dec11 = property(Node), _dec12 = property(Node), _dec13 = property(Material), _dec14 = property(Material), _dec15 = property(Material), _dec16 = property(Material), _dec17 = property(Material), _dec18 = property(Material), _dec(_class = (_class2 = class machine extends Component {
        ...
        setAward(type, subtype) {
          ...
          this.windowLayout3.setPosition(0, -5.7, 0); // spin页面方法

          let spinAct = this.node.parent.parent.parent.getChildByName('tuibiji').getChildByName('component').getChildByName('spin').getComponent(_crd && spin === void 0 ? (_reportPossibleCrUseOfspin({
            error: Error()
          }), spin) : spin);
          /* 此处是设置最终结果逻辑 */
          ...
          if (type == 1) {
            ...
            // 全盘奖
            // 测试随机挑选一个图案作为全盘奖
            let randomPrize = Math.floor(Math.random() * 8);
            /* 1 */
          ...
          let item1Arr = [this.spawnItem(this.itemSpritePathArray[index1Arr[0]]), this.spawnItem(this.itemSpritePathArray[index1Arr[1]]), this.spawnItem(this.itemSpritePathArray[index1Arr[2]])]; // 第二竖排结果

          let item2Arr = [this.spawnItem(this.itemSpritePathArray[index2Arr[0]]), this.spawnItem(this.itemSpritePathArray[index2Arr[1]]), this.spawnItem(this.itemSpritePathArray[index2Arr[2]])]; // 第三竖排结果

          let item3Arr = [this.spawnItem(this.itemSpritePathArray[index3Arr[0]]), this.spawnItem(this.itemSpritePathArray[index3Arr[1]]), this.spawnItem(this.itemSpritePathArray[index3Arr[2]])];
          this.adone = item1Arr;
          this.adtwo = item2Arr;
        ...
        replenishItem() {
          ...
          let path1Arr = [this.itemSpritePathArray[this.getRandomIndex()], this.itemSpritePathArray[this.getRandomIndex()], this.itemSpritePathArray[this.getRandomIndex()]];
          let path2Arr = [this.itemSpritePathArray[this.getRandomIndex()], this.itemSpritePathArray[this.getRandomIndex()], this.itemSpritePathArray[this.getRandomIndex()]];
          let path3Arr = [this.itemSpritePathArray[this.getRandomIndex()], this.itemSpritePathArray[this.getRandomIndex()], this.itemSpritePathArray[this.getRandomIndex()]]; // 第一竖排补充
        ...
        spawnLine(type, subtype) {
          let lialionLine = this.node.parent.getChildByName('liaisonLine');
          ...
          if (type == 1) {
            ...
            if (lialionLine.getChildByName('lineitem') != null) {
              ...
              let lineitem = instantiate(this.lineitem);
            ...
            if (lialionLine.getChildByName('lineitem2') != null) {
              ...
              let lineitem2 = instantiate(this.lineitem);
            ...
            if (lialionLine.getChildByName('lineitem3') != null) {
              ...
              let lineitem3 = instantiate(this.lineitem);
            ...
            if (lialionLine.getChildByName('lineitem4') != null) {
              ...
              let lineitem4 = instantiate(this.lineitem);
            ...
            if (lialionLine.getChildByName('lineitem5') != null) {
              ...
              let lineitem5 = instantiate(this.lineitem);
            ...
            if (subtype == 1) {
              ...
              if (this.randomsub[1] == 0) {
                if (lialionLine.getChildByName('lineitem1') != null) {
                  ...
                  let lineitem1 = instantiate(this.lineitem);
        ...
        getRandomIndex() {
          // 随机获取一张图片的索引
          let index = Math.floor(Math.random() * this.itemSpritePathArray.length);
          return index;
        }
        ...
        onHandleClicked(type, subtype) {
          ...
          if (this.isFirstRoll) {
            ...
            let jpSw = this.node.parent.getChildByName('jpScore').getComponent(_crd && jpScorets === void 0 ? (_reportPossibleCrUseOfjpScorets({
              error: Error()
            }), jpScorets) : jpScorets);
            ...
            tween(this.windowLayout3).by(1, {
              ...
              let sprite = this.node.parent.parent.getChildByName('mainScreen').getComponent(MeshRenderer);
              let coinDo = this.node.parent.parent.parent.getComponent(_crd && coinCreate === void 0 ? (_reportPossibleCrUseOfcoinCreate({
                error: Error()
              ...
              setTimeout(() => {
                ...
                if (coinDo.allowed) {
                  ...
                  this.node.parent.parent.parent.getChildByName('tuibiji').getChildByName('component').getChildByName('spin').getComponent(_crd && spin === void 0 ? (_reportPossibleCrUseOfspin({
                    error: Error()
        ...
        xmlcountDown() {
          let xmlgame = this.node.parent.getChildByName('xmlgame').getComponent(_crd && xmlts === void 0 ? (_reportPossibleCrUseOfxmlts({
            error: Error()
          }), xmlts) : xmlts);
          let xmlti = this.node.parent.getChildByName('xmlgame').getChildByName('xmlTime');
          let coinDo = this.node.parent.parent.parent.getComponent(_crd && coinCreate === void 0 ? (_reportPossibleCrUseOfcoinCreate({
            error: Error()
          }), coinCreate) : coinCreate);
        ...
        ddlcountDown() {
          let ddlti = this.node.parent.getChildByName('ddlgame').getChildByName('ddltime');
          let ddlto = this.node.parent.getChildByName('ddlgame').getChildByName('ddltotal');
          let ddlgame = this.node.parent.getChildByName('ddlgame').getComponent(_crd && ddlts === void 0 ? (_reportPossibleCrUseOfddlts({
            error: Error()
          }), ddlts) : ddlts);
          let coinDo = this.node.parent.parent.parent.getComponent(_crd && coinCreate === void 0 ? (_reportPossibleCrUseOfcoinCreate({
            error: Error()
                  ...
                  if (ddlgame.awardTotal > 0) {
                    ...
                    if (coinDo.autoTimer == null) {
                      if (this.node.parent.getChildByName('ddlset') != null) {
                        ...
                        // 生成结算分数界面
                        let ddlset = instantiate(this.ddlsetItem);
        ...
        spinSwitch(type) {
          let spinAction = this.node.parent.parent.parent.getChildByName('tuibiji').getChildByName('component').getChildByName('spin');

          if (!type) {
            let Mless = setInterval(() => {
              if (spinAction.position.x >= 39.4) {
                clearInterval(Mless);
                spinAction.getComponent(_crd && spin === void 0 ? (_reportPossibleCrUseOfspin({
                  error: Error()
                }), spin) : spin).spinAc.stop();
              }
            }, 5);
          } else {
            spinAction.getComponent(_crd && spin === void 0 ? (_reportPossibleCrUseOfspin({
              error: Error()
            }), spin) : spin).spinAc.start();
          }
        } // 连线奖对应奖项闪烁开关
...
//# sourceMappingURL=34f023ea30b552ca178882e122ec574ca8a65bff.js.map