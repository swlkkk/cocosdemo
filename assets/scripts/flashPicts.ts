import { _decorator, Component, Node, Prefab, resources, SpriteAtlas, SpriteFrame, Sprite } from 'cc';
const { ccclass, property } = _decorator;

@ccclass('flashPicts')
export class flashPicts extends Component {
    public flash1: SpriteFrame = null
    public flash2: SpriteFrame = null
    public flash3: SpriteFrame = null
    public flash4: SpriteFrame = null
    public flash5: SpriteFrame = null
    public flash6: SpriteFrame = null
    public flash7: SpriteFrame = null
    public flash8: SpriteFrame = null
    public flashsy1: boolean = false
    public flashsy2: boolean = false
    public flashsy3: boolean = false
    public flashsy4: boolean = false
    public flashsy5: boolean = false
    public flashsy6: boolean = false
    public flashsy7: boolean = false
    public flashsy8: boolean = false
    ...
    // 连线奖特殊
    doFlashLine(num: number, type: boolean) {
        if (num == 0) {
            if (type) {
                if(this.pca == null) {
